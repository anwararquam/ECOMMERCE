...
const Register = () => {
  ...
  const handleSubmit=async(e)=>{
    e.preventDefault()
    try {
      const res=await axios.post(`${ip}/api/v1/auth/register`,{name,email,password,phone,address,answer});
      if(res.data.success){
  ...
  <div className="mb-3">
    ...
    onChange={(e)=>setAnswer(e.target.value)}
     className="form-control" id="exampleInputEmail" placeholder='What Is Your Favourite Car'
     required
     />
    </div>
